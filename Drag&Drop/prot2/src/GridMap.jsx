...
const DraggableObject = ({ id, x, y, onDrop}) => {
  ...
  return (
    ...
    ${id === 'game' && shopClicked ? 'game-clicked' : ''}`}
      ...
      style={style}
    >
      {id === 'house' && <img onClick={() => houseClick()} src={House} alt="House" width="100px" height="100px" />}
      {id === 'shop' && <img onClick={() => shopClick()} src={Store} alt="Shop" width="100px" height="100px"  />}
